...
execute_process(
  COMMAND "/etc/profiles/per-user/lenovo/bin/git" --git-dir=.git show-ref "v1.8.0"
  WORKING_DIRECTORY "/home/lenovo/prep/cpp/PathPlanning/build/standalone/_deps/packageproject.cmake-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/lenovo/prep/cpp/PathPlanning/build/standalone/_deps/packageproject.cmake-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/lenovo/prep/cpp/PathPlanning/build/standalone/_deps/packageproject.cmake-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
